...
export class Hoffman_CreditonCreditBillMeLaterPage {
  ...
  readonly productPB1002RB: Locator;
  ...
  readonly giftRecipientCB: Locator;
  ...
  constructor(page: Page) {
    ...
    this.productPB1002RB = page.locator("//input[@id='productPB-1002']")
    ...
    this.giftRecipientCB = page.locator('#isGift')
  ...
  async fillMailingAddress() {
    ...
    await this.mailingFirstNameTF.fill('JPTest');
    await this.mailingLastNameTF.fill('User');
    ...
    await this.mailingAddressTF.fill('10600 Highland Springs Ave');
    await this.page.getByText('10600 Highland Springs Avenue, Cherry Valley, CA, USA').click();
    await this.page.waitForTimeout(6000);
    await this.mailingAddress2TF.fill('My Street Park');
    await this.mailingPhoneNumberTF.fill('1234567890');
    await this.mailingEmailTF.fill('jp@mailinator.com');
  }
  ...
  async selectCountyBillingDropDown() {
    ...
    async clickGiftRecipientCB() {
    await expect(this.giftRecipientCB).toBeVisible({ timeout: 60000 });
    await this.giftRecipientCB.scrollIntoViewIfNeeded();
    await this.giftRecipientCB.check();
  ...
  async selectUSOfferDigitalOnly() {
    await expect(this.productPB1002RB).toBeVisible({ timeout: 60000 });
    await this.productPB1002RB.scrollIntoViewIfNeeded();
    await this.productPB1002RB.click();
  ...
  async fillMailingBillingAddress() {
    ...
    await this.userFirstNameValue.fill('Don');
    await this.userLastNameValue.fill('DeRose');
    ...
    await this.userEmailValue.fill('don@mailinator.com');
  }
  ...
  async fillGiftRecipientMailingAddress() {
    ...
    await this.recipientFirstName1lTF.fill('Sanjay');
    await this.recipientLastName1TF.fill('Test');
    ...
    await this.recipientEmail1TF.fill('sanjay@mailinator.com');
  }
