...
export class NewParamsInUrlUSNoFirstNamePage {
    page: Page;
    ...
    readonly firstNameMissingText: Locator;

    constructor(page: Page) {
        this.page = page;
        this.firstNameMissingText = page.locator("//span[text()='First Name is missing']")
    ...
    async validateFirstNameMissingText() {
        ...
        await this.userFirstNameValue.click();
        await this.page.keyboard.press('Tab');
        await expect(this.firstNameMissingText).toBeVisible({ timeout: 60000 });
        let text = await this.firstNameMissingText.textContent();
        return text;
    }
