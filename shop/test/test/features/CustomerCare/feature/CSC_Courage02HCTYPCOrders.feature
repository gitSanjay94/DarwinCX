...
Feature: Courage Special Cases - Courage 02HCTYPC Orders
  ...
  Scenario: Courage Special Cases - 3 Courage 02HCTYPC Mail Add Diff Order
    Given User opens Courage Special Cases - Courage 02HCTYPC Orders
    Then Validate Offer Has All Delivery Types text
    When Select offers from the drop downs
    And Enter values in Mailing and Billing Address form
