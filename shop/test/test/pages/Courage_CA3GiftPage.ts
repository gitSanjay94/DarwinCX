...
export class Courage_CA3GiftPage {
  ...
  readonly recipientFirstName3TF: Locator;
  readonly recipientLastName3TF: Locator;
  readonly recipientJobTitle3TF: Locator;
  readonly recipientCompanyName3TF: Locator;
  readonly recipientAddress3TF:  Locator;
  readonly recipientAddress23TF:  Locator;
  readonly recipientCity3TF: Locator;
  readonly recipientProvince3DD: Locator;
  readonly recipientPostalCode3TF: Locator;
  readonly recipientCountry3DD: Locator;
  readonly recipientPhoneNumber3TF: Locator;
  readonly recipientEmail3TF: Locator;
  ...
  constructor(page: Page) {
   ...
   this.cardNumber = page.locator("//input[@id='Field-numberInput']");
    ...
    this.transactionSuccessfulMsg = page.locator("//*[@id='thankYou']")
        ...
        this.summaryUSDTxtValue = page.locator('div.col-6 div.row >> text="USD$78.00"');
        ...
        this.recipientEmail2TF = page.locator('#recipientEmail2')
         ...
         this.recipientFirstName3TF = page.locator('#recipientFirstName3')
        this.recipientLastName3TF = page.locator('#recipientLastName3')
         this.recipientJobTitle3TF = page.locator('#recipientJobTitle3')
        this.recipientCompanyName3TF = page.locator('#recipientCompanyName3')
        this.recipientAddress3TF = page.locator('#recipientAddress3')
        this.recipientAddress23TF = page.locator('#recipientAddress23')
        this.recipientCity3TF = page.locator('#recipientCity3')
        this.recipientProvince3DD = page.locator('#recipientProvince3')
        this.recipientPostalCode3TF = page.locator('#recipientPostalCode3')
        this.recipientCountry3DD = page.locator('#recipientCountry3')
        this.recipientPhoneNumber3TF = page.locator('#recipientPhoneNumber3')
        this.recipientEmail3TF = page.locator('#recipientEmail3')
...
async clickAddGiffReceipentButton2() {
...
async fillGiftRecipientMailingAddressCA() {
    ...
    // }
     ...
     async validateCartSummaryUSDTxtValue() {
       ...
       async fillGiftRecipientbyClickingAddRecipientButtonCA() {
        await expect(this.recipientFirstName2TF).toBeVisible({ timeout: 60000 });
        await this.recipientFirstName2TF.scrollIntoViewIfNeeded();
        await this.recipientFirstName2TF.fill('recipientFirstName' + faker.person.firstName());
        await this.recipientLastName2TF.fill('recipientLastName' + faker.person.lastName());
        await this.recipientCompanyName2TF.fill('recipientCompanyName' + faker.company.name());
        await this.recipientJobTitle1TF.fill('Automation Engineer');
        await this.recipientAddress2TF.fill('150 Nexus Ave');
        await this.page.getByText('150 Nexus Avenue, Brampton, ON, Canada').click();
        await this.page.waitForTimeout(6000);
        await this.recipientAddress22TF.fill('The 32-bit address points to the');
        await this.recipientPhoneNumber2TF.fill('3234567890');
        await this.recipientEmail2TF.fill(faker.internet.exampleEmail());
    }

     async fillGiftRecipientbyClickingAddRecipientButton3CA() {
        await expect(this.recipientFirstName3TF).toBeVisible({ timeout: 60000 });
        await this.recipientFirstName3TF.scrollIntoViewIfNeeded();
        await this.recipientFirstName3TF.fill('recipientFirstName' + faker.person.firstName());
        await this.recipientLastName3TF.fill('recipientLastName' + faker.person.lastName());
        await this.recipientCompanyName3TF.fill('recipientCompanyName' + faker.company.name());
        await this.recipientJobTitle3TF.fill('Automation Engineer');
        await this.recipientAddress3TF.fill('11 Polson St');
        await this.page.getByText('11 Polson Street, Toronto, ON, Canada').click();
        await this.page.waitForTimeout(6000);
        await this.recipientAddress23TF.fill('The 32-bit address points to the');
        await this.recipientPhoneNumber2TF.fill('3234567890');
        await this.recipientEmail3TF.fill(faker.internet.exampleEmail());
    }
                }