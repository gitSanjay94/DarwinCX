...
export class Hoffman_INTPrintDigitalWithNoUpsellPage {
  ...
  readonly productPB1007: Locator;
  ...
  constructor(page: Page) {
    ...
    this.productPB1007 = page.locator("//input[@id='productPB-1007']")
  ...
  async selectINTOfferDigitalOnly() {
    ...
    async selectINTOfferPrintDigitalOnly() {
    await expect(this.productPB1007).toBeVisible({ timeout: 60000 });
    await this.productPB1007.scrollIntoViewIfNeeded();
    await this.productPB1007.click();
  ...
  async selectCANOfferPrintOnly() {
    ...
    await this.userCountry.scrollIntoViewIfNeeded();
    await this.userCountry.selectOption('FR')
