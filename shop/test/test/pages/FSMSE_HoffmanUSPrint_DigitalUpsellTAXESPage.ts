...
export class FSMSE_HoffmanUSPrint_DigitalUpsellTAXESPage {
  ...
  constructor(page: Page) {
    ...
    this.digitalArchiveText = this.page.getByText('1 Year Digital Archive Access (This option is only available with a digital subscription)');
    this.digitalArchiveCheckBox = this.page.locator("//input[@id='offer2']")
    this.taxValue = page.locator('//div[@class="row"]//div[@class="text-right col"]');
