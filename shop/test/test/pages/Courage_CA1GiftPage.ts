...
export class Courage_CA1GiftPage {
  ...
  constructor(page: Page) {
    ...
    this.transactionSuccessfulMsg = page.locator("//*[@id='thankYou']")
        ...
        this.summaryUSDTxtValue = page.locator('div.col-6 div.row >> text="USD$26.00"');
...
async selectCountrySpecificSubscription() {
 await this.productPB1136RB.waitFor({ timeout: 50000, state: 'visible' });
    // Click the element
